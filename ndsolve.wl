...
Chop[{values[[1]]+1/2,Abs[values[[2]]]^2-1/2,Total[(values[[1]]\[Transpose])^2]/2+Total[Abs[values[[3]]\[Transpose]]^2]}]
(*1/2 (-Conjugate[values[[2]]] (-values[[3]]-I values[[4]])-values[[2]] (-values[[3]]+I values[[4]]))}]*)
]
];


runRandomInits=Function[{startEq},
...
singleRun[startEq,Flatten[{initsb,initsEm,initsEl}]]
]
];
