...
Block[{
hamkinb=Total[(hSz[#])&/@Range[sites+1,2sites]],
hamIntAndFEqs=Total[( 
...
hamdisb=Total[dis[[#]](2hSz[#+sites])&/@Range[sites]],
eqnsSm,eqnsSz,initsSm,initsSz,eqnsEm,eqnsEl,initsEm,initsEl,start
},
eqnsSm=Sm[#]'[t]==(intU[t]hamkinb-hopt[t]hamIntAndFEqs+hamdisb)[[1,#,1]]&/@Range[numbos];
eqnsSz=Sz[#]'[t]==(intU[t]hamkinb-hopt[t]hamIntAndFEqs+hamdisb)[[1,#,2]]&/@Range[numbos];
initsSm=Sm[#][0]==0&/@Range[numbos];
initsSz=Sz[#][0]==0&/@Range[numbos];
eqnsEm=Em[#1,#2]'[t]==(-hopt[t]hamIntAndFEqs+hamdisf)[[2,1,#1,#2]]&@@@midPairs;
eqnsEl=El[#1,#2]'[t]==(-hopt[t]hamIntAndFEqs+hamdisf)[[2,2,#1,#2]]&@@@lowPairs;
